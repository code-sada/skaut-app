        ...
        {users.map((user: any) => (
          ...
          >
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-0.5">
                  <p className="text-sm text-gray-500 flex items-center gap-1">
                    <Mail className="w-3 h-3" /> {user.email || "Bez e-mailu"}
                  </p>
                  {user.patrol && (
                    <p className="text-sm text-blue-600 flex items-center gap-1">
                      <Users className="w-3 h-3" /> {user.patrol.name}
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span
                className={`px-3 py-1 text-xs font-bold rounded-full ${roleColors[user.role] || "bg-gray-100 text-gray-700"}`}
              >
          ...
          <div className="bg-white text-gray-900 p-8 rounded-2xl w-full max-w-md shadow-2xl">
            ...
            >
              ...
              <select
                ...
                className="w-full p-2.5 border rounded-lg bg-white text-gray-900 border-gray-200"
              >
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-700 text-white p-2.5 rounded-lg font-bold transition-colors mt-2"
              >
                Uložit účet
              </button>
            </form>
